...
Electrically, the pack is split into two 8s halves. Current flows from one half, down and then into 5 12awg wires on the bottom which join the halves. Current then comes up the other side and out. These wires are soldered on and recessed into the pack cell holders.
...
![Thermistor routing illustrated](/images/panasonic_32ah/panasonic_18650_32ah_temp_sensor_layout.png)
